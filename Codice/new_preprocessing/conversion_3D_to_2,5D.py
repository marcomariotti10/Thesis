...
def process_file(i, file, ply_directory, folder_path):
    """Process a single PLY file and convert it to a grid map CSV."""
...
def generate_grid_map(ply_directory, folder_path, lidar_number):
    """Process all PLY files for a given LiDAR sensor using threading."""
    ...
    for i, file in enumerate(ply_files):
        thread = threading.Thread(target=process_file, args=(i, file, ply_directory, folder_path))
