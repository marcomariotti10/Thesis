...
if __name__ == "__main__":
    ...
    try:
        ...
        sensors = []
        static = []
        t1 = threading.Thread(target = spawn_static_sensors(sensors_config1, sensors, static, world, LOCAL))
        t1.start()
        threads.append(t1)

        t2 = threading.Thread(target = spawn_static_sensors(sensors_config2, sensors, static, world, LOCAL))
        t2.start()
        threads.append(t2)

        t3 = threading.Thread(target = spawn_static_sensors(sensors_config3, sensors, static, world, LOCAL))
        t3.start()
        threads.append(t3)
