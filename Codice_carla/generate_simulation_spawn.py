...
if __name__ == "__main__":
    ...
    try:
        ...
        static_car_bboxes = world.get_level_bbs(carla.CityObjectLabel.Car)
        static_mbike_bboxes = world.get_level_bbs(carla.CityObjectLabel.Motorcycle)
        static_bike_bboxes = world.get_level_bbs(carla.CityObjectLabel.Bicycle)
        static_bike_bboxes += static_mbike_bboxes
        spawn_vehicles(client, tm, 30, LOCAL)
